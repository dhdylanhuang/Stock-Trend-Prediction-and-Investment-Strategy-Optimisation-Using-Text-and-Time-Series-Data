...
MODEL_SAVE_PATH = Path(os.environ.get('MODEL_SAVE_PATH', RUN_ROOT / 'trained_models_multiclass'))
...
MODEL_SAVE_PATH = MODEL_SAVE_PATH if "MODEL_SAVE_PATH" in globals() else Path("trained_models_multiclass")
...
def _resolve_benchmark_dir():
    root = Path('/mnt/primary/benchmarking/results')
...
output_dir = OUTPUT_ROOT / 'simulation' / 'multiclass' / 'no-meta'
...
# folder_path = 'trained_models_multiclass/'
