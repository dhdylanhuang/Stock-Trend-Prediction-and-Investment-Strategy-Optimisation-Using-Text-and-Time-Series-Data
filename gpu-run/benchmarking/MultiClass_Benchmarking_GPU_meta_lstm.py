...
RESULTS_ROOT = Path(os.environ.get('RESULTS_ROOT', RUN_ROOT / 'meta-results'))
            ...
            if pipeline.problem_type in ['classification', 'multiclass']:
                ...
                if agg_cm is not None:
                    plot_confusion(
                        ...
                        save_path=RESULTS_OUT_DIR / f"{model_type}_{horizon_tag}_agg_confusion_counts.png"
                    )
                    ...
                    plot_confusion(
                        ...
                        save_path=RESULTS_OUT_DIR / f"{model_type}_{horizon_tag}_agg_confusion_row_normalized.png"
                    )
        else:
